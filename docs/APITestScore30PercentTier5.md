...
```typescript
import type { APITestScore30PercentTier5 } from 'schooldigger'
...
const example = {
  ...
  "low": null,
  "high": null,
} satisfies APITestScore30PercentTier5
...
const exampleParsed = JSON.parse(exampleJSON) as APITestScore30PercentTier5

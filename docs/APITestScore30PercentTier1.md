...
```typescript
import type { APITestScore30PercentTier1 } from 'schooldigger'
...
const example = {
  ...
  "low": null,
  "high": null,
} satisfies APITestScore30PercentTier1
...
const exampleParsed = JSON.parse(exampleJSON) as APITestScore30PercentTier1
